trigger BudgetcStats on Budget__c(after insert, after update, after delete, after undelete) {
  try {
    ...
    // hoopla.NotifierGlobal.processNotifications('Budget__cStats', Trigger.newMap, Trigger.oldMap, changeType);
  }
  catch(Exception e) {
