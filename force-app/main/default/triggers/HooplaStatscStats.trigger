trigger HooplaStatscStats on HooplaStats__c(after insert, after update, after delete, after undelete) {
  try {
    ...
    // hoopla.NotifierGlobal.processNotifications('HooplaStats__cStats', Trigger.newMap, Trigger.oldMap, changeType);
  }
  catch(Exception e) {
